...
export const GRADIENTES_PASTEIS = [
  ...
  'bg-gradient-to-r from-teal-200 to-emerald-200',
  'bg-gradient-to-r from-sky-200 to-cyan-200',
];

export const GRADIENTES_VERSICULOS_DIARIOS = [
  ...
  'linear-gradient(160deg, #d9f99d 0%, #a7f3d0 100%)',
  'linear-gradient(160deg, #fef08a 0%, #d9f99d 100%)',
  'linear-gradient(160deg, #a5f3fc 0%, #bae6fd 100%)',
  'linear-gradient(160deg, #bfdbfe 0%, #c7d2fe 100%)',
  'linear-gradient(160deg, #ddd6fe 0%, #e9d5ff 100%)',
  'linear-gradient(160deg, #f5d0fe 0%, #fbcfe8 100%)',
  'linear-gradient(160deg, #fecdd3 0%, #fecaca 100%)',
  'linear-gradient(160deg, #a7f3d0 0%, #99f6e4 100%)',
  'linear-gradient(160deg, #e2e8f0 0%, #bae6fd 100%)',
  'linear-gradient(160deg, #e4e4e7 0%, #ddd6fe 100%)',
  'linear-gradient(160deg, #e7e5e4 0%, #fed7aa 100%)',
];
